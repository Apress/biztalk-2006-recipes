if exists  (select * from sysobjects where name = 'BizTalkToCustomerInsert' and type = 'P')
...
**
** Description: Inserts records into the Customer Table for the SQL Adapter Stored Procedure Recipe
**           
**
*/
BEGIN
